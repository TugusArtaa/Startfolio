  ...
  return (
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ? "0 0 8px rgba(34, 42, 53, 0.06), 0 1px 1px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(34, 42, 53, 0.04), 0 0 2px rgba(34, 42, 53, 0.08), 0 4px 16px rgba(47, 48, 55, 0.05), 0 1px 0 rgba(255, 255, 255, 0.1) inset"
          : "none",
        ...
        return (
          <a
            ...
            className={cn(
              ...
              isActive &&
                "text-white font-bold bg-teal-600 rounded-full shadow transition-colors"
            )}
            key={`link-${idx}`}
            href={item.link}
          >
...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-2xl button text-black text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";

  const variantStyles = {
    primary: "bg-gradient-to-b from-teal-400/20 to-teal-300/20 shadow-md",
